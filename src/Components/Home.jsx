  ...
  return (
    <>
      <div>
        ...
        <div
          className="w-full sm:w-full h-full sm:h-full bg-slate-200 flex flex-col space-x-4 sm:flex
     sm:flex-col justify-center m-auto 2xl:mb-10 sm:overflow-hidden mt-3"
        >
          <div
            className="flex sm:flex-col justify-around"
            data-aos="fade-right"
            data-aos-delay="100"
            data-aos-duration="1000"
          >
            <img
              src={imageMe}
              alt="my image"
              className="h-[500px] sm:h-[150px] sm:w-[210px] sm:m-auto"
              data-aos="zoom-in"
              data-aos-delay="100"
              data-aos-duration="1000"
            />
              <div className="flex flex-col pt-20">
                <h3
                  className="text-7xl font-bold leading-normal sm:text-3xl sm:font-bold sm:text-center relative right-20"
                  style={Font}
                >
                  {homeText.first}
                </h3>
                <h2
                  className="text-7xl font-bold leading-normal relative right-20 sm:text-3xl sm:right-3 sm:text-center sm:top-8"
                  style={Font}
                >
                  {homeText.second}
                </h2>
                <a
                  ...
                  className="font-semibold w-[350px] sm:w-[200px]
                  ...
                  rounded-xl sm:rounded-md text-center relative right-14 sm:relative sm:right-3 sm:top-10"
                  style={Font}
                >
                  {link.firstText}
                </a>
          ...
          <div
            className="pt-5 flex justify-center sm:pt-20 relative right-2 pb-4"
            data-aos="zoom-out"
            data-aos-delay="100"
            data-aos-duration="1000"
          >
            <div className="flex justify-center bg-blue-200 w-fit gap-3">
              <FaHtml5
                className="w-[80px] h-[50px] fill-red-600 sm:w-[50px]
         border border-t-4 border-b-2 border-r-2 border-l-2 border-blue-500 rounded-md hover:animate-pulse"
              />
              <FaCss3Alt
                className="w-[80px] h-[50px] fill-blue-500 sm:w-[50px]
               border border-t-4 border-b-2 border-r-2 border-l-2 border-blue-500 rounded-md hover:animate-pulse"
              />
              <DiJavascript1
                className="w-[80px] h-[50px] sm:w-[50px]
               border border-t-4 border-b-2 border-r-2 border-l-2 border-blue-500 rounded-md hover:animate-pulse"
              />
              <SiTailwindcss
                className="w-[80px] h-[50px] text-blue-400 sm:w-[50px]
               border border-t-4 border-b-2 border-r-2 border-l-2 border-blue-500 rounded-md hover:animate-pulse"
              />
              <FaReact
                className="w-[80px] h-[50px] text-blue-400 sm:w-[50px]
